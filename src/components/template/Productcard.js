...
export default function ProductCarousel() {
  ...
  return (
    <div className="container m-auto lg:mb-45   flex flex-col px-8">
      <h1 className="relative top-10 text-sm dark:text-black lg:text-2xl px-4 lg:mt-5 mb-10 lg:mb-20 font-medium">
        ...
        <div className="relative -top-10 w-full max-w-[900px] h-[350px] flex items-center justify-center">
          {products.map((product, i) => {
            ...
            return (
              <motion.div
                key={product.id}
                className={`absolute w-[60%] mt-5 lg:w-150 md:w-[50%] h-[300px]  lg:h-[500px] rounded-2xl shadow-lg overflow-hidden transition-all duration-700 ${
                  pos === "center"
                    ? "z-30 scale-100"
                    : pos === "left" || pos === "right"
